<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">Manajemen Presensi</div>
    </div>
...
<section class="content">
	<div class="portlet portlet-trans box col-md-12">
	    <div class="portlet-body">
          	<form action="<?=base_url('presensi/addagenda')?>" method="post" enctype="multipart/form-data" class="form-vertical table-form form-empty">
	    		<h4>Presensi mentoring masih kosong, silahkan menambah dengan form dibawah ini</h3>
	    				...
	    				<div class="col-md-9">
	    					<div class="form-group">
	    						<?php
									...
									echo form_dropdown('nama',$options,'first',"id='jenis' class='form-control'");
								?>
	    					</div>
	    				</div>
	  				</div>
